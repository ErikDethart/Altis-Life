...
_Btn1 buttonSetAction "[] spawn life_fnc_repairTruck; closeDialog 0;";

if ((life_inv_toolkit >= 1) && {alive life_interactionTarget} && {([life_interactionTarget] call life_fnc_isDamaged)}) then {_Btn1 ctrlEnable true;} else {_Btn1 ctrlEnable false;};

if (playerSide isEqualTo west) then {
    _Btn2 ctrlSetText localize "STR_vInAct_Registration";
    _Btn2 buttonSetAction "[life_interactionTarget] spawn life_fnc_searchVehAction; closeDialog 0;";

    _Btn3 ctrlSetText localize "STR_vInAct_SearchVehicle";
    _Btn3 buttonSetAction "[life_interactionTarget] spawn life_fnc_vehInvSearch; closeDialog 0;";

    _Btn4 ctrlSetText localize "STR_vInAct_PullOut";
    _Btn4 buttonSetAction "[life_interactionTarget] spawn life_fnc_pulloutAction; closeDialog 0;";
    if (crew _curTarget isEqualTo []) then {_Btn4 ctrlEnable false;};

    _Btn5 ctrlSetText localize "STR_vInAct_Impound";
    _Btn5 buttonSetAction "[life_interactionTarget] spawn life_fnc_impoundAction; closeDialog 0;";
    ...
    if (_curTarget isKindOf "Ship") then {
        ...
        if (!isNil "_id") then {
            if !(_id in getDLCs 1) then {
                ...
                _Btn6 buttonSetAction "player moveInDriver life_interactionTarget; closeDialog 0;";
            ...
            _Btn6 buttonSetAction "life_interactionTarget setPos [getPos life_interactionTarget select 0, getPos life_interactionTarget select 1, (getPos life_interactionTarget select 2)+0.5]; closeDialog 0;";
    ...
    if (_curTarget isKindOf "Ship") then {
        ...
        if (!isNil "_id") then {
            if !(_id in getDLCs 1) then {
                ...
                _Btn2 buttonSetAction "player moveInDriver life_interactionTarget; closeDialog 0;";
            ...
            _Btn2 buttonSetAction "life_interactionTarget setPos [getPos life_interactionTarget select 0, getPos life_interactionTarget select 1, (getPos life_interactionTarget select 2)+0.5]; closeDialog 0;";
    ...
    if (typeOf _curTarget == "O_Truck_03_device_F") then {
        ...
        _Btn3 buttonSetAction "[life_interactionTarget] spawn life_fnc_deviceMine";
