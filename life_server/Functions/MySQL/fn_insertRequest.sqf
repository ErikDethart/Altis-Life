...
if (isNull _unit) exitWith {systemChat "ReturnToSender is Null!";}; //No one to send this to!
...
if (_queryResult isEqualType "") exitWith {[] remoteExecCall ["SOCK_fnc_dataQuery",(owner _unit)];}; //There was an entry!
if !(count _queryResult isEqualTo 0) exitWith {[] remoteExecCall ["SOCK_fnc_dataQuery",(owner _unit)];};
...
_query = format ["INSERT INTO players (pid, name, aliases) VALUES('%1', '%2', '%3')", _uid, _name, _alias];

[_query,1] call DB_fnc_asyncCall;
[] remoteExecCall ["SOCK_fnc_dataQuery",(owner _unit)];